...
class LogMessage(str, Enum):
    ...
    JSONPATH_RESULTS = 'The following occurrences were found for JSONPath ' '"{jsonpath_given}": {jsonpath_results}'
    FAIL_TO_PARSE_JSONPATH = 'Failed to parse JSONPath "{jsonpath_given}": {error}'
